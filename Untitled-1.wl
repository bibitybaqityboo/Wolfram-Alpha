...
MechSimCombined[] := Manipulate[
  ControlActive[
    ...
    Module[{mat, eVal, gVal, yield, results, rFinalInner, sf, plotBMD},
      ...
      results = calcCombined[axialLoad * 10^3, bentLoad * 10^3, torsionLoad * 10^3, length, outerR/1000, rFinalInner/1000, eVal, gVal];
